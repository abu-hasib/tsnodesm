...
export type PostsQuery = { __typename?: 'Query', getPosts: { __typename?: 'PostObject', hasMore: boolean, posts: Array<{ __typename?: 'Post', createdAt: any, title: string, id: number, creatorId: number, text: string, updatedAt: any }> } };
